...
$$ |  $$ |$$ |  $$ |$$ |\$  /$$ |$$ |      $$ |  $$ |
$$ |  $$ |$$ |  $$ |$$ | \_/ $$ |$$$$$$$$\ $$$$$$$  |
\__|  \__|\__|  \__|\__|     \__|\________|\_______/ /033[1;34m
                                                     
                                                     
  
                                                                  
[+] Author   : AHMED SHAR(🖤)
[+] Telegram : YI KIYA cheez hoti h?
[+] Github   : TVAHMED
[+] Version  : 1.2
[+] Tool     : Update done Free mi tool 
...
def Settings():
	...
	print(f'\x1b[1;91m\x1b[1;96m\x1b[1;97m\x1b[1;91m[\x1b[1;97m1\x1b[1;91m]\x1b[1;97mMOBILE\x1b[1;95m [Dsonfm]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r (°dson°) {P}{b}{loop}{P}•{b}{len(id)}{P}  • OK:{P}{H}{ok}{P} •  CP:{P}{M}{cp}{P} • ({bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
